...
| [:input](sel_input.asp) | `$(":input")` | All input elements |
| [:text](sel_input_text.asp) | `$(":text")` | All input elements with type="text" |
| [:password](sel_input_password.asp) | `$(":password")` | All input elements with type="password" |
| [:radio](sel_input_radio.asp) | `$(":radio")` | All input elements with type="radio" |
| [:checkbox](sel_input_checkbox.asp) | `$(":checkbox")` | All input elements with type="checkbox" |
| [:submit](sel_input_submit.asp) | `$(":submit")` | All input elements with type="submit" |
| [:reset](sel_input_reset.asp) | `$(":reset")` | All input elements with type="reset" |
| [:button](sel_input_button.asp) | `$(":button")` | All input elements with type="button" |
| [:image](sel_input_image.asp) | `$(":image")` | All input elements with type="image" |
| [:file](sel_input_file.asp) | `$(":file")` | All input elements with type="file" |
| [:enabled](sel_input_enabled.asp) | `$(":enabled")` | All enabled input elements |
| [:disabled](sel_input_disabled.asp) | `$(":disabled")` | All disabled input elements |
| [:selected](sel_input_selected.asp) | `$(":selected")` | All selected input elements |
| [:checked](sel_input_checked.asp) | `$(":checked")` | All checked input elements |
